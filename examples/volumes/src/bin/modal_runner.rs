//! The runner binary for the volumes example — the WHOLE thing, one line.
//!
...
//! shows the mounted volume riding on the entrypoint's config. The user never
//! writes `main()`.

modal_rust::modal_runner!(example_volumes);
