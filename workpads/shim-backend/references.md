...
| Facade RUN/deploy config memoization | crates/modal-rust/src/app.rs | 2026-06-06 | `RemoteHandle.function_ids` is keyed by entrypoint + effective RUN config; deploy publishes one function per entrypoint |
