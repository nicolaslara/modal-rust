...
| Owned per-function options | crates/modal-rust/src/registration.rs; crates/modal-rust/src/app.rs; crates/modal-rust/src/remote.rs; crates/modal-rust/src/deploy.rs; crates/modal-rust-cli/src/programmatic.rs | 2026-06-06 | Static FunctionConfig converts once into owned FunctionOptions; run/deploy/CLI carry the shared owned shape |
| RUN wrapper extraction | crates/modal-rust/src/remote/wrapper.py; crates/modal-rust/src/remote/wrapper_test.py; crates/modal-rust/src/remote.rs | 2026-06-06 | Run wrapper is included as real Python and configured via base64 JSON env instead of source templating |
